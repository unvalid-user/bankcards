...
VALUES
    ('admin', '$2a$10$NGYj/DULa7A2IxgAf49aAO5sSoIUhkLauyxKOimKcu4pfE4WNKi5C', 'ROLE_ADMIN'), -- admin
    ('user1', '$2a$10$eEO75GIaTgAcFn6rCIxKDuJE9h/ElWpv6hrxCEuso3cnNP9YuqUci', 'ROLE_USER'), -- user
    ('user2', '$2a$10$eEO75GIaTgAcFn6rCIxKDuJE9h/ElWpv6hrxCEuso3cnNP9YuqUci', 'ROLE_USER'); -- user
